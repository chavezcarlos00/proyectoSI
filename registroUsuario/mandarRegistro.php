...
<?php
    ...
    mysqli_query($conexion, "INSERT INTO usuarios (nombre_usuario,telefono,email,password)
    VALUES('$_POST[nombre_usuario]','$_POST[telefono]','$_POST[email]','$_POST[password]')");
?>
    <div class="container w-75 bg-dark mt-5 rounded shadow">
        <div class="row">
